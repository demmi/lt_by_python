...
print(
    "Множество set1 является подмножеством set2? Ответ: "
    + ("ДА" if set1.issubset(set2) else "НЕТ")
)
print(
    "Множество set2 является подмножеством set1? Ответ: "
    + ("ДА" if set2.issubset(set1) else "НЕТ")
)
# =-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-
