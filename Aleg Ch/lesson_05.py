...
# 7) git add . - добавляем для фиксации все файлы в папке или git add <file> для одного файла
# или git restore <file>, чтобы отменить изменения в рабочем каталоге
# 8) проверяем в Terminal командой git status - видим зафиксированные файлы зеленого цвета
# 9)
#
